...
if "%1" == "release" (
    cl %CFLAGS_RELEASE% "code\win32_d3d11_example.cpp" /Fo:build\ /Fe:build\win32_d3d11_app.exe /link %LIBS% %D3D11_LIBS%
    ...
    cl %CFLAGS% "code\win32_d3d11_example.cpp" /Fo:build\ /Fe:build\win32_d3d11_app.exe /link %LIBS% %D3D11_LIBS% ".\external\OptickCore.lib"
