...
if "%1" == "release" (
    cl %CFLAGS_RELEASE% %INCLUDES% "code\win32_d3d11_example.cpp" /Fo:build\ /Fe:build\win32_d3d11_app.exe /link %LIBS% %D3D11_LIBS% /ignore:4099
    ...
    cl %CFLAGS% %INCLUDES% "code\win32_d3d11_example.cpp" /Fo:build\ /Fe:build\win32_d3d11_app.exe /link %LIBS% %D3D11_LIBS% ".\external\OptickCore.lib" /ignore:4099
